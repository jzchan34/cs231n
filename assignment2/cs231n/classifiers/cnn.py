...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        d = height//2 * width//2 * num_filters
    ...
    def loss(self, X, y=None):
        ...
        #conv - relu - 2x2 max pool - affine - relu - affine - softmax
        out1, cache1 = conv_forward_im2col(X, W1, b1, conv_param)
        ...
        dx2, grads['W3'], grads['b3'] = affine_backward(dx, cache6)
        dx3 = relu_backward(dx2, cache5)
        dx4, grads['W2'], grads['b2'] = affine_backward(dx3, cache4)
        dx5 = max_pool_backward_fast(dx4, cache3)
        dx6 = relu_backward(dx5, cache2)
        dx7, grads['W1'], grads['b1'] = conv_backward_im2col(dx6, cache1)
